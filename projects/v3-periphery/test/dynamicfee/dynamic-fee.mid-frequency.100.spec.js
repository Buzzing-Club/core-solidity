...
describe("Dynamic fee simulation: mid frequency 100 trades", function () {
  it("records 1000U mid-frequency trades with on-chain fee data", async function () {
    this.timeout(240000);
    ...
    const out = writeScenarioReport({
      filePrefix: "dynamic-fee-mid-frequency-100trades-1000U",
      title: "Dynamic Fee Mid Frequency (100 trades, 1000U each)",
      params: {
        filterPeriod,
        decayPeriod,
        reductionFactor,
    ...
    console.log("[dynamic-fee-mid] report saved:", out);
  });
});
