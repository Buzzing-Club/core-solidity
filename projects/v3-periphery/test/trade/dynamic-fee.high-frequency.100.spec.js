...
describe("Dynamic fee simulation: high frequency 100 trades", function () {
  it("records 1000U high-frequency trades with on-chain fee data", async function () {
    this.timeout(240000);
    ...
    const out = writeScenarioReport({
      filePrefix: "dynamic-fee-high-frequency-100trades-1000U",
      title: "Dynamic Fee High Frequency (100 trades, 1000U each)",
      params: {
        filterPeriod,
        decayPeriod,
        reductionFactor,
    ...
    console.log("[dynamic-fee-high] report saved:", out);
  });
});
