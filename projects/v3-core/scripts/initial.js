...
async function main() {
    ...
    EigenPool = (await ethers.getContractFactory('BubblySwapPool',signer)).attach("0x1aC56f10dc79772dA1487A87C21C7e51AC91E7aC");
    ...
    await(await EigenPool.initialize(sqrtpirice,{gasLimit:3000000})).wait();
