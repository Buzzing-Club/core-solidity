...
import './interfaces/IBubblySwapLmPool.sol';
import './interfaces/IMasterChefV3.sol';
import './interfaces/IBubblySwapLmPoolDeveloper.sol';

contract BubblySwapLmPool is IBubblySwapLmPool {
  ...
  IBubblySwapPool public immutable pool;
  ...
  constructor() {
    (address poolAddress, address masterChefAddress) = IBubblySwapLmPoolDeveloper(msg.sender).parameters();
    pool = IBubblySwapPool(poolAddress);
