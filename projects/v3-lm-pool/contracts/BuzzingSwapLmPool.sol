...
import './interfaces/IBuzzingSwapLmPool.sol';
import './interfaces/IMasterChefV3.sol';
import './interfaces/IBuzzingSwapLmPoolDeveloper.sol';

contract BuzzingSwapLmPool is IBuzzingSwapLmPool {
  ...
  IBuzzingSwapPool public immutable pool;
  ...
  constructor() {
    (address poolAddress, address masterChefAddress) = IBuzzingSwapLmPoolDeveloper(msg.sender).parameters();
    pool = IBuzzingSwapPool(poolAddress);
